...
add_files -norecurse ${HDL_DIR}/sinelut.vhd
update_compile_order -fileset sources_1

add_files -fileset consts_1 -norecurse ${XDC_DIR}/Zybo-Z7-Master.xdc
...
set_property SOURCE_SET {} [get_filesets sim_2]
add_files -fileset sim_2 -norecurse ${HDL_DIR}/sinelut_tb.vhd ${HDL_DIR}/sinelut.vhd
